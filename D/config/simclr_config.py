...
class SimCLRConfig:
    ...
    def __init__(self, config):
        ...
        model_path = None
        epoch_num = None
        save_num_epochs = None
        self.fine_tuning = SimCLRConfig.FineTuning(**config['fine_tuning'], model_path=model_path, epoch_num=epoch_num, save_num_epochs=save_num_epochs)
